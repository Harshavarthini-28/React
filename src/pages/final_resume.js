                ...
                <div className='maincontainer'>
                    <div className='output'>
                        <div className='container'>
                            ...
                            <br />
                            <h1 className='project-done'>ACADEMIC PROJECTS:</h1>
                            <br />
                            ...
                            <br />
                            <h1 className='area-of-intrest'>AREA OF INTEREST:</h1>
                            <br />
                            ...
                            <br />
                            <h1 className='workshop-attended'>INTERNSHIPS:</h1>
                            <br />
                            ...
                            <br />
                            <h1 className='personal-skill'>CO CURRICULAR ACTIVITIES:</h1>
                            <br />
